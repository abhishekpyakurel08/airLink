export function drawQRCode(canvas: HTMLCanvasElement, text: string): void {
...
function drawCornerPattern(ctx: CanvasRenderingContext2D, x: number, y: number, cellSize: number): void {
  ctx.fillStyle = '#000000';
