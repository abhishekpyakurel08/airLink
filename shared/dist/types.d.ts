...
export interface MediaControlPayload extends BaseMessage {
    type: MessageType.MEDIA_PLAY_PAUSE | MessageType.MEDIA_NEXT | MessageType.MEDIA_PREV | MessageType.MEDIA_MUTE;
}
...
export type AirLinkWSMessage = AuthRequestMessage | AuthResponseMessage | PeerStatusMessage | MediaControlPayload | VolumeSetPayload | BaseMessage | TabListResponseMessage | TabActionMessage | NavigateUrlMessage | TouchpadMoveMessage | TouchpadClickMessage | TouchpadScrollMessage | ClipboardSendMessage | ErrorMessage;
